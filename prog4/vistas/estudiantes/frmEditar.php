  ...
  <body>
    ...
    <div class="card-header ">
        ...
        <div class="card-body">
  <form action="../../acciones/estudiantes/modificar.php" name='frmDatos' method="Post" >
  <label>ID</label>
    <br>
  ...
  ?>
    ...
    <br>
    <button type="submit" name="Enviar" id="Enviar "value="Enviar"class ="btn btn-success">GUARDAR</button>
  </form>
  </div>
  </div>
